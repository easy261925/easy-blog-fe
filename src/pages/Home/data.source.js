        ...
        children: {
          ...
          children: [
            ...
            },
            {
              name: 'content',
              className: 'feature7-block-content',
              children: 'Java SpringBoot SpringCloud',
            },
          ],
        },
      },
...
export const Feature00DataSource = {
  ...
  titleWrapper: {
    ...
    children: [{ name: 'title', children: '生活与读书' }],
  },
  childWrapper: {
    ...
    children: [
      {
        ...
        childWrapper: {
          className: 'slogan',
          children: [{ name: 'content0', children: <p>{}</p> }],
        },
      },
      {
        name: 'block2',
      ...
      },
      {
        ...
        childWrapper: {
          children: [
            ...
            { href: '#', name: 'link1', children: 'Ant Design Pro' },
            { href: '#', name: 'link1', children: 'SpringBoot' },
            { href: '#', name: 'link1', children: 'Oracle' },
          ],
        },
      },
    ],
  ...
  copyright: {
    ...
    children: (
      <span>
        ...
        &nbsp;&nbsp;ICP证:浙B2-20100257&nbsp; &nbsp; &nbsp;&nbsp;Copyright © 2019 蚂蚁金融服务集团
        <br />
      </span>
    ),
  },
